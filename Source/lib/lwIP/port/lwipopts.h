 ...
 */
#define MEMCPY(dst,src,len)             my_copy((void*)dst,(void*)src,len);
 ...
 */
#define TCP_WND                         ((MEMP_NUM_TCP_SEG >> 2) * TCP_MSS)
 ...
 * See @ref altcp_api
 */
#define LWIP_ALTCP                      defined(__MBEDTLS__)
 ...
 */
#define LWIP_ALTCP_TLS                  defined(__MBEDTLS__)
 ...
 */
#define TCPIP_THREAD_STACKSIZE          LV5_STACK_SIZE
 ...
 * sys_thread_new() when the thread is created.
 */
#define SLIPIF_THREAD_STACKSIZE         LV5_STACK_SIZE
 ...
 * sys_thread_new() when the thread is created.
 */
#define SLIPIF_THREAD_PRIO              LV6_TASK_PRIO
 ...
 * sys_thread_new() when the thread is created.
 */
#define DEFAULT_THREAD_STACKSIZE        LV5_STACK_SIZE
 ...
 * sys_thread_new() when the thread is created.
 */
#define DEFAULT_THREAD_PRIO             LV6_TASK_PRIO
